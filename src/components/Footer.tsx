        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="p-1.5 bg-gradient-to-br from-electric-blue to-deep-blue rounded-lg">
                <Crown className="w-5 h-5 text-navy" />
              </div>
              <span className="font-display font-bold text-lg tracking-tighter uppercase italic">
                Dominator<span className="text-electric-blue">Study</span>
              </span>
            </div>
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-electric-blue hover:text-navy transition-all">
          ...
          <div>
            <h4 className="font-bold mb-6 text-sm uppercase tracking-widest text-electric-blue">Product</h4>
            <ul className="space-y-4 text-soft-blue text-sm font-light">
              <li><a href="#features" className="hover:text-white transition-colors">Features</a></li>
              <li><a href="#how-it-works" className="hover:text-white transition-colors">How it works</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Pricing</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Scholarship</a></li>
            </ul>
          </div>

          <div>
            <h4 className="font-bold mb-6 text-sm uppercase tracking-widest text-electric-blue">Company</h4>
            <ul className="space-y-4 text-soft-blue text-sm font-light">
          ...
          <div>
            <h4 className="font-bold mb-6 text-sm uppercase tracking-widest text-electric-blue">Legal</h4>
            <ul className="space-y-4 text-soft-blue text-sm font-light">
